...
public class Messages {
    ...
    public static final String EXISTING_ROLE = "Existing role name";
    public static final String ERROR_WHILE_AUTHENTICATION = "Error while authenticating";
    public static final String USER_NOT_IDENTIFICATION = "User not identification";
    public static final String USER_AUTHENTICATION = "User already authenticated ";
}
